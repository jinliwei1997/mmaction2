...
ann_file_train = f'data/MM21-DS/subset/train_anno_subset_random'
ann_file_val = f'data/MM21-DS/subset/val_anno_subset_random'
ann_file_test = f'data/MM21-DS/subset/val_anno_subset_random'
mc_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/MM21/ds/subset/tsn_r50_8f_50e_k400_n2n'
