...
ann_file_train = f'data/MM21-PT/train_anno'
ann_file_val = f'data/MM21-PT/val_anno'
ann_file_test = f'data/MM21-PT/val_anno'
mc_cfg = dict(
...
optimizer = dict(
    ...
    weight_decay=0.0005)  # this lr is used for 8*2 gpus
