...
model = dict(
    type='Recognizer2D',
    backbone=dict(type='ResNet', pretrained='torchvision://resnet50', depth=50, norm_eval=False, frozen_stages=4),
    cls_head=dict(
        type='TSNHead',
        num_classes=212,
        in_channels=2048,
...
log_level = 'INFO'
work_dir = './work_dirs/tsn_r50_1x1x8_100e_ugc_rgb_imagenet_frozen/'
load_from = None
resume_from = None
workflow = [('train', 1)]