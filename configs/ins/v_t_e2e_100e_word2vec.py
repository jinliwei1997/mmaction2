...
data_root = '/mnt/lustre/DATAshare2/duanhaodong/Ins_videos'
data_root_val = '/mnt/lustre/DATAshare2/duanhaodong/Ins_videos'
ann_file_train = '/mnt/lustre/jinliwei/ins/ins_train'
ann_file_val = '/mnt/lustre/jinliwei/ins/ins_val'
ann_file_test = '/mnt/lustre/jinliwei/ins/ins_val'
mc_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/ins_word2vec_100e'
load_from = None
resume_from = None
workflow = [('train', 1)]
