...
data_root = ''
data_root_val = ''
ann_file_train = '/mnt/lustre/jinliwei/annotation/bili_video_dm_partial_split_raw'
ann_file_val = '/mnt/lustre/jinliwei/annotation/bili_video_dm_partial_split_raw'
ann_file_test = '/mnt/lustre/jinliwei/annotation/bili_video_dm_partial_split_raw'
mc_cfg = dict(
...
dist_params = dict(backend='nccl',port = 29568)
log_level = 'INFO'
work_dir = './work_dirs/bili_v_t_e2e_100e_dm_partial_split_raw'
load_from = None
resume_from = None
workflow = [('train', 1)]
