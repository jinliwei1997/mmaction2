...
data_root = ''
data_root_val = ''
ann_file_train = '/mnt/lustre/jinliwei/annotation/bili_video_title_partial'
ann_file_val = '/mnt/lustre/jinliwei/annotation/bili_video_title_partial'
ann_file_test = '/mnt/lustre/jinliwei/annotation/bili_video_title_partial'
mc_cfg = dict(
...
dist_params = dict(backend='nccl',port = 29567)
log_level = 'INFO'
work_dir = './work_dirs/bili_v_t_e2e_100e_title_partial'
load_from = None
resume_from = None
workflow = [('train', 1)]
