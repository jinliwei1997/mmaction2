...
data_root = ''
data_root_val = ''
ann_file_train = '/mnt/lustre/jinliwei/annotation/bili_video_dm_partial_split_denoise'
ann_file_val = '/mnt/lustre/jinliwei/annotation/bili_video_dm_partial_split_denoise'
ann_file_test = '/mnt/lustre/jinliwei/annotation/bili_video_dm_partial_split_denoise'
mc_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/bili_v_t_e2e_100e_dm_partial_split_denoise'
load_from = None
resume_from = None
workflow = [('train', 1)]
