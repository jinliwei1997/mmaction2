...
data_root = ''
data_root_val = ''
ann_file_train = '/mnt/lustre/jinliwei/annotation/usv_30827'
ann_file_val = '/mnt/lustre/jinliwei/annotation/usv_1000'
ann_file_test = '/mnt/lustre/jinliwei/annotation/usv_1000'
mc_cfg = dict(
...
dist_params = dict(backend='nccl',port = 29578)
log_level = 'INFO'
work_dir = './work_dirs/usv_30827'
load_from = None
resume_from = None
workflow = [('train', 1)]
