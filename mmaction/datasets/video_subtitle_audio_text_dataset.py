...
class VideoSubtitleAudioTextDataset(BaseDataset):
    ...
    def load_annotations(self):
        ...
        with open(self.ann_file, 'r') as fin:
            for line in fin:
                ...
                video_info['subtitle_text_path'] = video_info['text_path'].replace('title','subtitle')
                idx += 1
    ...
    def evaluate(self,
        ...
        allowed_metrics = ['vt_retrieval_metrics', 'tv_retrieval_metrics']
